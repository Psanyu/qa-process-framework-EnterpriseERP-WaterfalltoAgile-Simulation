**Executive Summary**
L&T Healthcare E-Commerce QA Process Framework Simulation

**Project Overview**

This project simulates a healthcare e-commerce platform developed under an enterprise delivery model inspired by Larsen & Toubro (L&T).

The objective of this simulation was to demonstrate structured QA governance across both traditional and Agile execution models, showcasing end-to-end Software Testing Life Cycle (STLC) implementation.
...
The project showcases both strategic planning and hands-on QA execution capability suitable for mid-level QA and hybrid automation roles.
